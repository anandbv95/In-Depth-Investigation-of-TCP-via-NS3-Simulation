...
int main(int argc , char * argv[])
{
	  ...
	  Link1.SetQueue("ns3::DropTailQueue", "MaxPackets",UintegerValue(uint32_t(100)));
	  Link1.SetDeviceAttribute  ("DataRate", StringValue ("50Mbps"));
	  ...
	  Link2.SetDeviceAttribute    ("DataRate", StringValue ("50Mbps"));
