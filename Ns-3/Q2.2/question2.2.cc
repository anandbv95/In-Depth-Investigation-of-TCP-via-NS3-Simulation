...
main (int argc, char *argv[])
{
  ...
  p2ph1.SetQueue("ns3::DropTailQueue",  "MaxPackets",UintegerValue(30));
  ...
  p2ph2.SetQueue("ns3::DropTailQueue",  "MaxPackets",UintegerValue(6));
  ...
  sourceApps1.Stop (Seconds (10.0));
    ...
    OnOffHelper onoff1 ("ns3::TcpSocketFactory",InetSocketAddress (interfaces5.GetAddress (1), port));
  ...
  PacketSinkHelper sink2 ("ns3::TcpSocketFactory", //installing sink
                         InetSocketAddress (Ipv4Address::GetAny (), port));
